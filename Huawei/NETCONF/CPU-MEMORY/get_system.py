...
FILTER = """
<filter type="subtree">
  <cpu-memory xmlns="urn:huawei:yang:huawei-cpu-memory"/>
</filter>
"""
...
def get_cpu_memory(router):
    ...
    try:
        with huawei_connect(router) as m:
            ...
            archivo = f"{nombre}_cpu-memory.xml"
            #archivo = f"outputs/{nombre}_cpu-memory.xml"

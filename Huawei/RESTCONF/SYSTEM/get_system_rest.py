...
def get_system_restconf(router):
    ...
    # Endpoint para el contenedor system de Huawei VRP8
    url = f"https://{host}:{port}/restconf/data/huawei-system:system"
    ...
    try:
        with urllib.request.urlopen(
            ...
            archivo_salida = f"{nombre}_system.json"
            # archivo_salida = f"outputs_json/{nombre}_system.json"
